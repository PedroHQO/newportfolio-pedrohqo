...
const projects = [
  ...
  {
    id: 2,
    title: "Material Requirements Planning API",
    description: "Sistema full-stack desenvolvido para otimização de linha de produção industrial. Implementação de Algoritmo Guloso (Greedy Algorithm) para maximização de lucro baseado em gargalos de estoque. Cobertura de testes unitários para regras de negócio e testes E2E para fluxos de interface.",
    tech: ["Java(Spring Boot)", "PostgreSQL", "Next.js 14", "Docker", "JUnit/Mockito", "Cypress"],
    repoLink: "https://github.com/PedroHQO/desafio-mao_na_massa-autoflex.git",
    image: "/autoflex_bom_system.png"
  },
  {
    id: 3,
